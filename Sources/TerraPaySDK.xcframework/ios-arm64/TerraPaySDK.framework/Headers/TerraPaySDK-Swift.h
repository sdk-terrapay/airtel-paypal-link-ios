...
@class NSURL;
SWIFT_CLASS("_TtC11TerraPaySDK14TerraPayClient")
@interface TerraPayClient : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) TerraPayClient * _Nonnull shared;)
...
@class NSString;
SWIFT_CLASS("_TtC11TerraPaySDK17TerraPayErrorInfo")
...
typedef SWIFT_ENUM(NSInteger, TerraPayResultType, open) {
